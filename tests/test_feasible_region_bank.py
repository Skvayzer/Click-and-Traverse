...
import pytest
from cat_ppo.furniture.feasible_region_bank import validate
...
NEW = ROOT/'data/furniture/cat_flat_hand_balance_v4_20260921/manifest.json'
OLD = ROOT/'data/furniture/cat_flat_hand_balance_v3_20260921/manifest.json'


def test_v4_preserves_sampling_and_rejects_unrelated_manifest_changes():
