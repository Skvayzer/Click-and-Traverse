...
exec .venv-mjlab/bin/python train_cat_mjlab.py run \
  ...
  --run-dir outputs/cat_hand_speed_v6_30720_20260922 \
  --num-envs 30720 --batch-size 768 --num-minibatches 40 --unroll-length 32 \
  --hand-speed-curriculum --hand-speed-curriculum-window 256 \
  --hand-speed-curriculum-success-threshold 0.80 \
  --hand-speed-curriculum-demote-threshold 0.40 \
