#!/usr/bin/env bash
# Prepared only. NOT launched. Uses a new run directory; never resumes cat_s5.
set -euo pipefail
...
.venv-mjlab/bin/python train_cat_mjlab.py run \
  ...
  --checkpoint-native outputs/cat_hand_feasible_v5_seeded_pilot50_20260921/best.pt \
  --fresh-optimizer \
